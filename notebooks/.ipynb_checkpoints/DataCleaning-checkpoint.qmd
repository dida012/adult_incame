...
adult_df['education_level'] = adult_df['education'].map({
    ...
    'doctorate':'tertiary',
    'prof-school':'tertiary',
    'some-college':'same college',
    'assoc-acdm':'associate',
    'assoc-voc':'associate',
    'hs-grad':'secondary-high school graduate',
    '12th':'secondary',
    '11th':'secondary',
    '9th':'secondary',
    '10th':'secondary',
...
```{python}
#adult_df.to_csv('20.csv', index=False)
```
...
```{python}
#adult_df = adult_df.drop('continent', axis=1)
```
